...
func InsertData(tree map[string]interface{}, data insertdecode.WebTraffic) {

	iterateAndCheck(tree, data)

}

func iterateAndCheck(tree map[string]interface{}, data insertdecode.WebTraffic) {
...
func createNewNode(data insertdecode.WebTraffic, m map[string]interface{}) {
...
func addNewNode(data insertdecode.WebTraffic, m map[string]interface{}) {
